...
public class NYPizzaIngredientFactory implements PizzaIngerdientFactory {
    ...
    public Sauce createSauce(String type) {
        if (type == "black"){
            ...
            throw new NullPointerException("no such sauce in NY Ingredient factory");
    }
    ...
    public Clam createClam(String type) {
        if (type == "fresh"){
            ...
            throw new NullPointerException("no such Clam in NY Ingredient factory");
    }
    ...
    public Cheese createCheese(String type) {
        if (type == "thick"){
            ...
            throw new NullPointerException("no such Cheese in NY Ingredient factory");
    }
}
